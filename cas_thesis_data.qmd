...
# Alle Kantone und Wahljahre, die in den Daten vorkommen
vektor_kanton <- unique(df_all$Kanton)
vektor_wahljahr <- 2015:2025

# Vollständigen Grid erzeugen
df_grid <- expand_grid(Kanton = vektor_kanton, Wahljahr = vektor_wahljahr)

# Mit den Daten verknüpfen
df_all <- left_join(df_grid, df_all, by = c("Kanton", "Wahljahr"))
...
view(elec_kantonsregierung_changelog)
```
