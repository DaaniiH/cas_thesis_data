...
### Dataframes kombinieren, Parteinamen vereinheitlichen, alte df löschen (opt.)
...
view(elec_gemeinde_lvl_gemeinde)
view(elec_gemeinde_lvl_kt)
view(elec_gemeinde_lvl_state)
view(elec_kanton_lvl_kt)
view(elec_kanton_lvl_state)
view(elec_nr_sr_lvl_state)
