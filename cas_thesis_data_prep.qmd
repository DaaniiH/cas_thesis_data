...
# a) Für den Zeitraum 2019–2025 (alle Variablen, die bis 2025 verfügbar sind):
df_2019_2025 <- voting_5y_final %>%
  filter(year >= 2019 & year <= 2025)

# b) Für den Zeitraum 2019–2023 (nur Variablen, die bis 2023 verfügbar sind):
...
GGally::ggpairs(cor_data_numeric[, 1:5])



#5. Lineare Regression: Welche Faktoren beeinflussen das Abstimmungsergebnis?
# Einfaches Modell mit Parolen
model1 <- lm(volkja_proz ~ state_parole_Ja + kt_parole_Ja + gemeinde_parole_Ja, data = df_2019_2025)
summary(model1)

# Erweitertes Modell mit weiteren Variablen
model2 <- lm(volkja_proz ~ state_parole_Ja + kt_parole_Ja + gemeinde_parole_Ja +
