...
### Zwei-Achsen-Modell je statistischer Stadt auf der Landkarte

**ACHTUNG: Vergleichsweise "Rechen- und Speicherplatzintensiv"**

```{r}
#| label: load_gemeinde_lvl_party
...
```{r}
#| label: create_miniplots_and_visualize_on_map
...
### Tatsächliches Ergebnis und Verteilung der Parolen (Ja-Nein-Keine) pro Jahr
